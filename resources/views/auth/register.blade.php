                    ...
                    <div class="row">
                      ...
                      <div class="col-12 col-md-6 mt-4 ">
                          ...
                          <form method="POST" action="/register" class="p-5 mt-5" id="register">
                            ...
                            <div class="form-outline text-center mb-3">
                                <input type="email" name="email" id="email" class="login-form-field" placeholder="Email">
                            </div>
                            ...
                            <div class="d-flex align-items-center justify-content-center mt-3">
                                <a href="/login" type="button" class="btn btn-success">Hai già un'account? Clicca qui!</a>
                            </div>
                            </form>
                        </div>
